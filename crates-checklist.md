...
2. Update version number in `Cargo.toml` as required for each of the crates: `omnipaxos`, `omnipaxos_macros`, `omnipaxos_storage`, `omnipaxos_runtime`, and `omnipaxos_ui`.
