...
pub const OMNI_PAXOS_TICK_PERIOD: Duration = Duration::from_millis(10);
pub const OUTGOING_MESSAGE_PERIOD: Duration = Duration::from_millis(1);
pub const OMNI_PAXOS_UI_TICK_PERIOD: Duration = Duration::from_millis(200);
...
#[cfg(feature = "with_omnipaxos_ui")]
pub const EXIST_TIMEOUT: Duration = Duration::from_secs(100);
